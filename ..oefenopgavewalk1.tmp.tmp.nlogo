...
to setup
  ...
  create-turtles numberofturtles                                ;; create two turtles
  [
...
to walk1
  ...
  ask turtles [
    ;;face one-of neighbors4 with [shade-of? [color] of myself pcolor or shade-of? black pcolor]        ;; face N, E, S, or W
    forward 1                                                                                         ;; advance one step

    if [pcolor] of patch-ahead 1 != black
    [face min-one-of neighbors4 with
      [shade-of? [color] of myself pcolor
        or shade-of? black pcolor] [visits]
    ]

    set pcolor scale-color color 20 0 50 + 0.5 * visits
     ]
...
"" ""
PENS
"pen-geel" 1.0 0 -1184463 true "" "plot count patches with [pcolor = shade-of? scale-color yellow 20 0 50 pcolor] "
"pen-blauw" 1.0 0 -13345367 true "" "plot count patches with [pcolor = shade-of? scale-color blue 20 0 50 pcolor]"
